...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * String ArrayList named "words" initialized with one to ten
         */
        ArrayList<com.example.android.miwok.Word> words = new ArrayList<com.example.android.miwok.Word>();

        //words.add("one");
        //com.example.android.miwok.Word word = new com.example.android.miwok.Word("one", "lutti");
        ...
        Log.v("NumbersActivity", " ArrayList declared.  Size is: "+ words.size());

        /**
         * Create a TextView for each and add it to the current layout.
         */
